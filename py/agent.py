...
from py.tool_calling import ToolCallingStrategy, strategy_for_model
        ...
        try:
            ...
            if self._compressor:
                ...
                if est >= threshold:
                    ...
                    from py.compression import flush_memories
            ...
            if self._enable_prompt_caching:
                from py.prompt_caching import apply_prompt_caching
